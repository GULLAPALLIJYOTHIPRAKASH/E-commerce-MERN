...
const { AddToCart, GetAllCartItems, UpdateCart, DeleteCart } = require("../../../controllers/Shop/cart-controller");
...
router.delete("/delete-cart/:userId/:productId" , Check_User , DeleteCart);
